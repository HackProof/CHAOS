...
/*
void _dbg_enter_lock(void) {
  setDbg_lock_cnt(ch_get_dbg(), (cnt_t)1);
  //ch.dbg.lock_cnt = (cnt_t)1;
}
void _dbg_leave_lock(void) {
  setDbg_lock_cnt(ch_get_dbg(), (cnt_t)0);
...
// #define _dbg_enter_lock() (dbg_set_lock_cnt(ch_get_dbg_ptr(), (cnt_t)1))
// #define _dbg_leave_lock() (dbg_set_lock_cnt(ch_get_dbg_ptr(), (cnt_t)0))
