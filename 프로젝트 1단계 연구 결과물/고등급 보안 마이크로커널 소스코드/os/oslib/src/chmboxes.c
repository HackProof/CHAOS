...
void chMBResetI(mailbox_t *mbp) {
  ...
  mbp->cnt   = (size_t)0;
  mbp->reset = true;
  chThdDequeueAllI(secret_kValue, &mbp->qw, MSG_RESET());
  chThdDequeueAllI(secret_kValue, &mbp->qr, MSG_RESET());
}
  ...
  do {
    ...
    if (chMBGetFreeCountI(mbp) > (size_t)0) {
      *mbp->wrptr++ = msg;
      ...
      chThdDequeueNextI(secret_kValue, &mbp->qr, MSG_OK());
      chSchRescheduleS();
  ...
  do {
    ...
    if (chMBGetUsedCountI(mbp) > (size_t)0) {
      *msgp = *mbp->rdptr++;
      ...
      chThdDequeueNextI(secret_kValue, &mbp->qw, MSG_OK());
      chSchRescheduleS();
