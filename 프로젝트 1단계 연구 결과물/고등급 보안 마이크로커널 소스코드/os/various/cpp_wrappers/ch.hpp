...
namespace chibios_rt {
  ...
  public:
    ...
    void requestTerminate(void) const {
      ...
      chThdTerminate(secret_kvalue, thread_ref);
    }
    ...
    msg_t wait(void) {
      ...
      msg_t msg = chThdWait(secret_kvalue, tp); // TODO: secret_kvalue
      return msg;
    }
  ...
  public:
    ...
    static void exit(msg_t msg) {
      ...
      chThdExit(secret_kvalue, msg); // TODO
    }
  ...
  public:
    ...
    ThreadReference start(tprio_t prio) override {
      ...
      return ThreadReference(chThdCreateStatic(secret_kvalue, secret_kvalue, wa, sizeof(wa), prio,
                                               _thd_start, this));
    }
  };
  ...
  public:
    ...
    void resumeI(msg_t msg) {
      ...
      chThdResumeI(secret_kvalue, &thread_ref, msg);
    }
    ...
    void resumeS(msg_t msg) {
      ...
      chThdResumeS(secret_kvalue, &thread_ref, msg);
    }
  };
  ...
  public:
    ...
    void dequeueNextI(msg_t msg) {
      ...
      chThdDequeueNextI(secret_kvalue, &threads_queue, msg);
    }
    ...
    void chdequeueAllI(msg_t msg) {
      ...
      chThdDequeueAllI(secret_kvalue, &threads_queue, msg);
    }
};
