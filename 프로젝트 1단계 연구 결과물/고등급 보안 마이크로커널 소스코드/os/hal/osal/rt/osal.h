...
static inline void osalThreadSleepS(sysinterval_t delay) {
  ...
  chThdSleepS(0, delay); // 첫번째 인자: SecretValue_t (TODO)
}
...
static inline void osalThreadSleep(sysinterval_t delay) {
  ...
  chThdSleep(delay); // 첫번째 인자: SecretValue_t (TODO)
}
...
static inline void osalThreadResumeI(thread_reference_t *trp, msg_t msg) {
  ...
  chThdResumeI(secret_kValue, trp, msg);
}
...
static inline void osalThreadResumeS(thread_reference_t *trp, msg_t msg) {
  ...
  chThdResumeS(secret_kValue, trp, msg);
}
...
static inline void osalThreadDequeueNextI(threads_queue_t *tqp, msg_t msg) {
  ...
  chThdDequeueNextI(secret_kValue, tqp, msg);
}
...
static inline void osalThreadDequeueAllI(threads_queue_t *tqp, msg_t msg) {
  ...
  chThdDequeueAllI(secret_kValue, tqp, msg);
}
