...
static void rt_test_005_002_execute(void) {
  ...
  test_set_step(1);
  {
    threads[0] = chThdCreateStatic(secret_kValue, secret_kValue, wa[0], WA_SIZE, chThdGetPriorityX()+5, thread1, "A");
    threads[1] = chThdCreateStatic(secret_kValue, secret_kValue, wa[1], WA_SIZE, chThdGetPriorityX()+1, thread1, "B");
    threads[2] = chThdCreateStatic(secret_kValue, secret_kValue, wa[2], WA_SIZE, chThdGetPriorityX()+3, thread1, "C");
    threads[3] = chThdCreateStatic(secret_kValue, secret_kValue, wa[3], WA_SIZE, chThdGetPriorityX()+4, thread1, "D");
    threads[4] = chThdCreateStatic(secret_kValue, secret_kValue, wa[4], WA_SIZE, chThdGetPriorityX()+2, thread1, "E");
  }
...
static void rt_test_005_003_execute(void) {
  ...
  test_set_step(2);
  {
    threads[0] = chThdCreateStatic(secret_kValue, secret_kValue, wa[0], WA_SIZE, chThdGetPriorityX() - 1,
                                   thread2, 0);
...
static void rt_test_005_004_execute(void) {
  ...
  test_set_step(1);
  {
    threads[0] = chThdCreateStatic(secret_kValue, secret_kValue, wa[0], WA_SIZE, chThdGetPriorityX()+1, thread1, "A");
  }
...
static void rt_test_005_005_execute(void) {
  ...
  test_set_step(1);
  {
    threads[0] = chThdCreateStatic(secret_kValue, secret_kValue, wa[0], WA_SIZE, chThdGetPriorityX()+1, thread3, 0);
  }
...
static void rt_test_005_006_execute(void) {
  ...
  test_set_step(3);
  {
    threads[0] = chThdCreateStatic(secret_kValue, secret_kValue, wa[0], WA_SIZE,
