...
static void rt_test_006_001_execute(void) {
  ...
  test_set_step(3);
  {
    threads[0] = chThdCreateStatic(secret_kValue, secret_kValue, wa[0], WA_SIZE, prio+1, thread1, "E");
    threads[1] = chThdCreateStatic(secret_kValue, secret_kValue, wa[1], WA_SIZE, prio+2, thread1, "D");
    threads[2] = chThdCreateStatic(secret_kValue, secret_kValue, wa[2], WA_SIZE, prio+3, thread1, "C");
    threads[3] = chThdCreateStatic(secret_kValue, secret_kValue, wa[3], WA_SIZE, prio+4, thread1, "B");
    threads[4] = chThdCreateStatic(secret_kValue, secret_kValue, wa[4], WA_SIZE, prio+5, thread1, "A");
  }
...
static void rt_test_006_002_execute(void) {
  ...
  test_set_step(2);
  {
    threads[0] = chThdCreateStatic(secret_kValue, secret_kValue, wa[0], WA_SIZE, chThdGetPriorityX()-1, thread2H, 0);
    threads[1] = chThdCreateStatic(secret_kValue, secret_kValue, wa[1], WA_SIZE, chThdGetPriorityX()-2, thread2M, 0);
    threads[2] = chThdCreateStatic(secret_kValue, secret_kValue, wa[2], WA_SIZE, chThdGetPriorityX()-3, thread2L, 0);
    test_wait_threads();
...
static void rt_test_006_003_execute(void) {
  ...
  test_set_step(2);
  {
    threads[0] = chThdCreateStatic(secret_kValue, secret_kValue, wa[0], WA_SIZE, chThdGetPriorityX()-5, thread3LL, 0);
    threads[1] = chThdCreateStatic(secret_kValue, secret_kValue, wa[1], WA_SIZE, chThdGetPriorityX()-4, thread3L, 0);
    threads[2] = chThdCreateStatic(secret_kValue, secret_kValue, wa[2], WA_SIZE, chThdGetPriorityX()-3, thread3M, 0);
    threads[3] = chThdCreateStatic(secret_kValue, secret_kValue, wa[3], WA_SIZE, chThdGetPriorityX()-2, thread3H, 0);
    threads[4] = chThdCreateStatic(secret_kValue, secret_kValue, wa[4], WA_SIZE, chThdGetPriorityX()-1, thread3HH, 0);
    test_wait_threads();
    test_assert_sequence("ABCDE", "invalid sequence");
  }
...
static void rt_test_006_004_execute(void) {
  ...
  test_set_step(2);
  {
    threads[0] = chThdCreateStatic(secret_kValue, secret_kValue, wa[0], WA_SIZE, pa, thread4A, "A");
    threads[1] = chThdCreateStatic(secret_kValue, secret_kValue, wa[1], WA_SIZE, pb, thread4B, "B");
  }
...
static void rt_test_006_007_execute(void) {
  ...
  test_set_step(1);
  {
    ...
    threads[0] = chThdCreateStatic(secret_kValue, secret_kValue, wa[0], WA_SIZE, prio+1, thread6, "E");
    threads[1] = chThdCreateStatic(secret_kValue, secret_kValue, wa[1], WA_SIZE, prio+2, thread6, "D");
    threads[2] = chThdCreateStatic(secret_kValue, secret_kValue, wa[2], WA_SIZE, prio+3, thread6, "C");
    threads[3] = chThdCreateStatic(secret_kValue, secret_kValue, wa[3], WA_SIZE, prio+4, thread6, "B");
    threads[4] = chThdCreateStatic(secret_kValue, secret_kValue, wa[4], WA_SIZE, prio+5, thread6, "A");
  }
...
static void rt_test_006_009_execute(void) {
  ...
  test_set_step(2);
  {
    threads[0] = chThdCreateStatic(secret_kValue, secret_kValue, wa[0], WA_SIZE, prio+1, thread8, "A");
  }
  ...
  test_set_step(3);
  {
    threads[1] = chThdCreateStatic(secret_kValue, secret_kValue, wa[1], WA_SIZE, prio+2, thread6, "C");
  }
  ...
  test_set_step(4);
  {
    threads[2] = chThdCreateStatic(secret_kValue, secret_kValue, wa[2], WA_SIZE, prio+3, thread9, "B");
  }
