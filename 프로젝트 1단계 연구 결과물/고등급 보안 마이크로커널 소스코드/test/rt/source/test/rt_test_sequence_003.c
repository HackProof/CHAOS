...
static const testcase_t rt_test_003_001 = {
  "FRU - Thread Sleep functionality",
  NULL,
  NULL,
...
static void rt_test_003_002_execute(void) {
  ...
  test_set_step(1);
  {
    threads[0] = chThdCreateStatic(secret_kValue, secret_kValue, wa[0], WA_SIZE, chThdGetPriorityX()-5, thread, "E");
    threads[1] = chThdCreateStatic(secret_kValue, secret_kValue, wa[1], WA_SIZE, chThdGetPriorityX()-4, thread, "D");
    threads[2] = chThdCreateStatic(secret_kValue, secret_kValue, wa[2], WA_SIZE, chThdGetPriorityX()-3, thread, "C");
    threads[3] = chThdCreateStatic(secret_kValue, secret_kValue, wa[3], WA_SIZE, chThdGetPriorityX()-2, thread, "B");
    threads[4] = chThdCreateStatic(secret_kValue, secret_kValue, wa[4], WA_SIZE, chThdGetPriorityX()-1, thread, "A");
    test_wait_threads();
...
static const testcase_t rt_test_003_002 = {
  "FRU - Ready List functionality, threads priority order",
  NULL,
  NULL,
...
static const testcase_t rt_test_003_004 = {
  "FRU - Priority change test with Priority Inheritance",
  NULL,
  NULL,
